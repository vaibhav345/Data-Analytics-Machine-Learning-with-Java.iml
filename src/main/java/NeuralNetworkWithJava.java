...
public class NeuralNetworkWithJava {

	public NeuralNetworkWithJava() { }
    ...
    /** Implementing Delta 1. follows delta1 =(delta2).dot(W2.T) * A * (1 - A)
     */
    ...
    /** Updating the weights. follows W2 -= alpha * A.T.dot(delta2)
     */
    ...
    /** Updating the bias. follows b2 -= alpha * (delta2).sum(axis=0)
     */
    ...
    /** Implementing the Loss Function at each 100th Iteration. follows: loss = np.sum(-T * np.log(Y))
     */
	...
	public static void main(String[] args) {
		...
		System.out.println("Processing the Neural Network.");
	}
}
