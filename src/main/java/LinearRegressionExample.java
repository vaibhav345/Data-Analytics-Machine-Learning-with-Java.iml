...
public class LinearRegressionExample {
	...
	public static void main(String[] args) throws IOException {
		...
		//Getting the structure of the table:
		System.out.println("Printing the structure...");
		 ...
		 */
		System.out.println("Adjusted Rsquared for the model is: " + myHousePriceTrainer.adjustedRSquared());
		System.out.println("Rsquared for the model is: " + myHousePriceTrainer.RSquared());
		...
		double []  values = {20, 64, 7406, 7, 5, 2006, 2006, 684, 515, 1199, 1220, 1220, 2, 2, 6,
								2006, 2, 632, 54, 2006};
	
		double predictedaVal = myHousePriceTrainer.predict(values);
		System.out.println("The predicted Value: " + predictedaVal);
		System.out.println("The actual value: 194000");
