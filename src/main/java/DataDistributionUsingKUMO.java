...
public class DataDistributionUsingKUMO {

	public DataDistributionUsingKUMO() { }
	...
	/** A function to write words from String Column from the table to a txt file
	 */
	...
	public static void main(String[] args) throws IOException {
		...
		/** Efficient distribution of the data, Getting the mean, max, min and the median. Using Split Apply Combine Functions
		 */
		Table diabetesData  = Table.read().csv("../Diabetes_Data.csv");
		Table diabetes = diabetesData.structure();
		System.out.println(diabetes);

		/** Getting the Summaries from the diabetes age, t.summarize(column, functions...)
		 */
		...
		/** Correlation in the data. One feature (Scatter plot) vs another feature Many features (Heatmap)
		 */
        ...
        System.out.println("Creating a HeatMap with Smile.");
        ...
        System.out.println("Done with Smile.");
        ...
        /** Visualizing different data forms. Text (Word cloud), Number (bar charts)
         */
